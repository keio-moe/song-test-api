Sequel.migration do
  transaction
  change do
    create_table(:world_music_workshop_evaluation_entries) do
      primary_key :id
    ...
    create_table(:world_music_workshop_similarity_entries) do
      primary_key :id
      TrueClass :edited, null: false, default: false
    ...
    create_table(:world_music_workshop_rank_entries) do
      primary_key :id
      TrueClass :edited, null: false, default: false
      Integer :pair_id, null: false
